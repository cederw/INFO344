"use strict";
//JS to load the information from the webservice into the dashboard
window.onload = function () {
    //load all initial data and edit it into the DOM
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetAvailableMBytes",
        dataType: "json",
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetQCount",
        dataType: "json",
        success: function (msg) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetURLCount",
        dataType: "json",
        success: function (msg) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetLastTen",
        dataType: "json",
        success: function (msg) {
            console.log(msg);
            console.log(msg.d);
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetIndexSize",
        dataType: "json",
        success: function (msg) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetLines",
        dataType: "json",
        success: function (msg) {
            document.getElementById("tNum").innerHTML = msg.d.replace(/["]+/g, '');
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/WebService1.asmx/GetLastTitle",
        dataType: "json",
        success: function (msg) {
            document.getElementById("tLast").innerHTML = msg.d.replace(/["]+/g, '');
